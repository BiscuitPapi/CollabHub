								...
								<div class="card-body">
									...
									<form action="assets/php/add-club-app.php" method="POST">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="input-1" name ="club_name" placeholder="Enter Your Name">
										</div>
										...
										<!--Registration Link-->
										<div class="form-group">
											<label for="input-5">Registration Link:</label>
											<input type="text" class="form-control" id="input-5" name ="registration_link" placeholder="Enter the skill sets you wanted">
										</div>
