						...
						<li class="nav-item">
							<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
								<span class="user-profile">
									...
									<img class="img-circle" src="assets/php/image.php?picture=profile" alt="profile-image">	
								</span>
							</a>
							<ul class="dropdown-menu dropdown-menu-right">
								<li class="dropdown-item user-details">
									<a href="myProfile.php">
										<div class="media">
											<div class="avatar">
												<img class="align-self-start mr-3" src="assets/php/image.php?picture=profile" alt="profile-image">	
											</div>
						...
						<div class="col-lg-4">
							<div class="card profile-card-2">
								...
								<div class="card-body pt-5">
									<div class="avatar">
										<img src="assets/php/image.php?picture=profile" alt="profile-image" class="profile">			
									</div>
