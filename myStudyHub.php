...
<html lang="en">
	<head>
		...
		<script>
			...
			// function deleteStudyHub(event) {
			// 	event.preventDefault();

			// 	var studyhubID = this.dataset.studyhubId;
			// 	console.log("Deleting StudyHub with ID:", studyhubID);
			...
			// 		// Perform the necessary actions to delete the studyhub
			// 		// You can use AJAX to send a request to the server-side PHP script for deletion
			// 	});
