					...
					<div class="col-lg-6">
						<div class="card">
							<div class="card-body">
								...
								<form action="../assets/php/studyhub/process_editStudySession.php?studysession_id=<?php echo $studysession_id; ?>" method="POST">
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											...
											$datePart = substr($studysession_date, 0, 10);
											?>
											<input class="form-control" type="date" name="studysession_date" value="<?php echo isset($studysession_date) ? $datePart : ''; ?>" <?php if ($_SESSION['user_ID'] != $created_by) echo 'readonly'; ?>>
										</div>
									</div>
									<?php echo $studysession_date; ?>
									<div class="form-group row">
