				...
				<!--Group Application List-->
					...
					<div class="row">
						...
						<div class="col-12 col-lg-12">
							<div class="card">
								<!--Top Table-->
								<div class="card-header">Group Application List
									...
									<table class="table table-hover">
										...
										<tbody>
											<?php
												...
												$query = "SELECT * FROM `group-application` WHERE user_ID != '$user_ID';";
                                                            ...
                                                            echo '
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href="assets/php/process_applyGroupApplication.php?application_ID=' . $row['application_id'] . '" class="btn btn-success">Apply</a>
                                                                    </td>
                                                                </tr>
                                                            ';
