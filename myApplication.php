	...
	<head>
		...
		<script>
			function deleteGroupApplication(applicationID) {
				...
				$.ajax({
					url: 'assets/php/process_deleteGroupApplication.php',
					method: 'GET',
		...
		<div id="wrapper">
													...
													<div class="card">
														<div class="card-body">
                                                            <div class="d-flex justify-content-between">
                                                                ...
                                                                <div>
                                                                    <span class="badge badge-success clickable-addClub mr-2" style="cursor: pointer;"><i></i> + Create</span>
                                                                </div>
                                                            </div>
															<div class="table-responsive">
												...
												<div class="tab-pane" id="addGroup">
													<div class="row">
														<div class="col-md-12">
                                                            ...
                                                            <!-- Club Name -->
                                                            <div class="form-group">
                                                                <label for="input-7">Course:</label>
            ...
            <script>
                ...
                function addNewClub() {
                    ...
                    $.ajax({
                        url: 'assets/php/process_addClub.php',
                        method: 'POST',
                        data: {
                        ...
                        success: function (response) {
                            ...
                            if (status === "success") {
                                alert("A new club has been created with ID: " + newApplicationID);
                                closeAddClubModal();
