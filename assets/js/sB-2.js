        ...
        success: function (data) {
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            if (tempP != null) {
              var html = '<tr>' +
                '<th scope="row">' + (i + 1) + '</th>' +
                '<td><img src="data:image/jpeg;base64,' + tempP + '" alt="profile-image" class="align-self-start mr-3 rounded-circle" id="smallProfilePicture_2" style="width: 50px; height: 50px;">' + row['studyhub_name'] + '</td>' +
              ...
              var html = '<tr>' +
              '<th scope="row">' + (i + 1) + '</th>' +
               '<td><img src="https://via.placeholder.com/110x110" alt="profile-image" class="align-self-start mr-3 rounded-circle" id="smallProfilePicture_2" style="width: 50px; height: 50px;">' + row['studyhub_name'] + '</td>' +
              '<td style="text-align: center;">' + row['creator_name'] + '</td>' +
              '<td style="text-align: center;">' +
              row['member_count'] + // Display the member count
              '</td>' +
