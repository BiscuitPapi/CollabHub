function validateForm() {
  ...
  function showModal(responseText) {
    ...
    var firstLetter = responseText.charAt(0);
    // Set a timeout to hide the modal after 5 seconds
    setTimeout(function () {
      modal.style.display = 'none';
      alert("Thank you for your review!\n" + "You've given a rating of " + firstLetter + " stars based on your feedback.");
  ...
  function submitReview() {
    if (validateForm()) {
      ...
      xhr.open("POST", "../assets/php/review/process_addReview.php", true);
