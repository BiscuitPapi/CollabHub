      ...
      data.forEach(function (user) {
        ...
        var userContent = `
                                                              ...
                                                              <div class="row">
                                                                  ...
                                                                  <div class="col-lg-2">
                                                                  ${
                                                                      user.imageData !== null && user.imageData !== ""
                                                                      ? `<a href="viewProfile.php?user_ID=${user.user_ID}"><img src="data:image/jpeg;base64, ${user.imageData}" width="110" height="110"></a>`
                                                                      : `<a href="viewProfile.php?user_ID=${user.user_ID}"><img src="https://via.placeholder.com/110x110"></a>`
                                                                  }
                                                              </div>
                                                                  </div>
